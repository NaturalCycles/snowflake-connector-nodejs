// @azure/storage-blob is an optional peerDependency in the @naturalcycles/snowflake-sdk fork.
// It's loaded lazily inside createClient() so consumers that don't use Azure stages
    ...
    try {
      ...
      try {
        ...
        while (position < fileSize) {
          ...
          const blockId = Buffer.from(String(partNumber).padStart(10, '0')).toString('base64');
      ...
      await blockBlobClient.commitBlockList(blockIds, {
        metadata: buildAzureMetadata(meta, encryptionMetadata),
